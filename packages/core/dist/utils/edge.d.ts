...
export declare function getEdgePositions(sourceNode: GraphNode, sourceHandle: HandleElement | null, sourcePosition: Position, targetNode: GraphNode, targetHandle: HandleElement | null, targetPosition: Position): EdgePositions;
...
export declare function isEdgeVisible({ sourcePos, targetPos, sourceWidth, sourceHeight, targetWidth, targetHeight, width, height, viewport, }: IsEdgeVisibleParams): boolean;
